    ...
    bodyHTML: `
      ...
      <div id="dtab-overview">
        ...
        <div class="flex gap-2" style="margin-bottom:14px;flex-wrap:wrap">
          ...
          ${deal.hr_service?'<span style="font-size:11px;padding:2px 10px;border-radius:10px;background:#f0fdf4;color:#166534">👤 HR opportunity</span>':''}
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
        ...
        <div style="display:flex;flex-direction:column;gap:0">
          ...
          <div style="padding:10px 12px;background:var(--page-bg);border-radius:6px;margin-bottom:8px">
            <p style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.06em;color:var(--hint);margin-bottom:8px">Service opportunities</p>
            <div style="display:flex;gap:20px;align-items:flex-end">
              ...
              <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;padding-bottom:4px">

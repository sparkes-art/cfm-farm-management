  ...
  const harvestBodyHTML = [
    ...
    '<div class="form-row">',
      '<div class="form-group">',
        ...
        '<input class="form-input" id="hv-variety" type="text" placeholder="e.g. Sicot 748B3F" value="' + (existing?.variety || '') + '">',
      '</div>',
      '<div class="form-group">',
        '<label class="form-label">Total weight (kg)</label>',
        '<input class="form-input num" id="hv-ginned" type="number" step="1" placeholder="e.g. 150000" value="' + (existing?.ginned_weight || '') + '">',
      '</div>',
    '</div>',
    '<div class="form-group">',
